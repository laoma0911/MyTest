package com.medlinker.dentist.uac.api.base.dao.impl;
...
public abstract class BaseDaoImpl<T, PK extends Serializable> extends SqlSessionDaoSupport implements
        BaseDao<T, PK> {
